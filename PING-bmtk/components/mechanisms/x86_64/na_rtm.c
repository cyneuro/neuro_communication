...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 na_rtm /home/tyler/git_stage/Borgers-Examples-in-BMTK/31-ING_Entrainment/components/mechanisms/na_rtm.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/tyler/git_stage/Borgers-Examples-in-BMTK/31-ING_Entrainment/components/mechanisms/na_rtm.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"
