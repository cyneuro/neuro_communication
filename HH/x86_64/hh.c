...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 6, "cvodeieq");
 	...
 	ivoc_help("help ?1 hh /Users/vladimiromelyusik/neuro_communication/single_cell/modfiles/hh.mod\n");
...
static int _reset;
static char *modelname = "hh   squid sodium, potassium, and leak channels";
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/vladimiromelyusik/neuro_communication/single_cell/modfiles/hh.mod";
static const char* nmodl_file_text = 
  "TITLE hh   squid sodium, potassium, and leak channels\n"
  " \n"
  "COMMENT\n"
