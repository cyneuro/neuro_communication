...
void modl_reg() {
  if (!nrn_nobanner_) if (nrnmpi_myid < 1) {
    ...
    fprintf(stderr, " \"mechanisms//gap.mod\"");
    fprintf(stderr, " \"mechanisms//k_rtm.mod\"");
    fprintf(stderr, " \"mechanisms//k_wb.mod\"");
    fprintf(stderr, " \"mechanisms//leak.mod\"");
    fprintf(stderr, " \"mechanisms//na_rtm.mod\"");
    fprintf(stderr, " \"mechanisms//na_wb.mod\"");
